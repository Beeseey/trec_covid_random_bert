...
list_of_docids = read_docid_texts('corpus2/docids-rnd2.txt')
...
'''
file = open('corpus2/corpus2.txt', 'w+',encoding='utf-8')
csv_file = open('corpus2/corpus2.csv', 'w+', newline='',encoding='utf-8')
